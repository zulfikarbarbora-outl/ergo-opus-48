...
Opus 48 kbps preview MP3s for the **karoryfer.ergo** sample library.
...
- **Source**: [`zulfikarbarbora-outl/karoryfer.ergo`](https://github.com/zulfikarbarbora-outl/karoryfer.ergo)
- **Branch**: `master`

## URL pattern

```
https://raw.githubusercontent.com/zulfikarbarbora-outl/ergo-opus-48/master/<filename>.opus
```
